<?php
	echo "<div id='login-box3' class='login-popup'>
        <a href='#' class='close'><img src='images/close.png' class='btn_close' title='Close Window' alt='Close' /></a>
          <form method='post' class='signin' action='modul/mod_sidemenu/act/act_sd3.php'>
		  <input type='hidden' name=id_3 id='id_loginmodal3'>
