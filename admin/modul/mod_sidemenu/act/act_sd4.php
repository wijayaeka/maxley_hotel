...
include "../../../config/connect.php";
	...
	$id_p_5=mysql_query("SELECT id_sidemenu_parent4 FROM side_menu WHERE id_menu ='$_POST[id_4]' ");
	$f4=mysql_fetch_array($id_p_5);
	$f_id_p_5=$f4[id_sidemenu_parent4];
	
	$id_p_4=mysql_query("SELECT id_sidemenu parent3 FROM side_menu WHERE id_sidemenu ='$f_id_p_5' ");
