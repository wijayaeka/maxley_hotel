...
include('dbcon.php');
	...
	$query2 = mysql_query("select * from menu where id_parent = ".$id2." order by list_number desc");
...
function finishAjax2(id,response2){
  ...
  $('#'+id).fadeIn();
	...
	<form action="#" name="form2" id="form_menu" method="post" onsubmit="return alert_id();" enctype="multipart/form-data">
