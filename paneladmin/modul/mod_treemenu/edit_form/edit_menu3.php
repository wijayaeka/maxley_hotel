			...
			<table cellpadding='0' cellspacing='0' width='100%'class='table table-bordered table-striped' id='tSortable'>
				<thead>
                    <tr>
                                    ...
                                    <th width='25%'>Article Sub Menu 2</th>
                    ...
                    <tbody>";
					$tp = mysql_query("select * from article WHERE menu_stats = 'sm2' AND id_menu='$x[id_menu]' ");
