...
$id_reservasi = $_GET['id_reservasi'];
		...
		$total_room_query = mysql_query("select sum(price) as jumlah , room_amount, harga, date_in, date_out FROM  reservasi 
		...
		//grand total
		$total_service = mysql_fetch_array(mysql_query("select sum(price) as jumlah , date_in, date_out, room_amount FROM  reservasi 
												CROSS JOIN room_kategori on reservasi.id_room_kategori = room_kategori.id_room_kategori
												where reservasi.id_reservasi = '$id_reservasi'"));
