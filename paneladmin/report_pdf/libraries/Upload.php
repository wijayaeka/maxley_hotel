...
class CI_Upload {
	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		...
		if ( ! is_uploaded_file($_FILES[$field]['tmp_name']))
		{
			...
			switch($error)
			{
				case 1:	// UPLOAD_ERR_INI_SIZE
					...
					$this->set_error('Ukuran file terlalu besar');
					break;
				...
				case 4: // UPLOAD_ERR_NO_FILE
					$this->set_error('Tidak ada file yang terupload');
					//$this->set_error('upload_no_file_selected');
					break;
				case 6: // UPLOAD_ERR_NO_TMP_DIR
					//$this->set_error('upload_no_temp_directory');
					$this->set_error('Tidak ada directory untuk temporary');
					break;
				case 7: // UPLOAD_ERR_CANT_WRITE
					//$this->set_error('upload_unable_to_write_file');
					$this->set_error('Tidak ada hak akses untuk menulis di folder upload');
					break;
				case 8: // UPLOAD_ERR_EXTENSION
					//$this->set_error('upload_stopped_by_extension');
						$this->set_error('Tipe file tidak diijinkan');
					break;
				default :  	$this->set_error('Tidak ada file yang terupload'); //$this->set_error('upload_no_file_selected');
					break;
			}
		...
		{
			$this->set_error('Format file tidak sesuai');
		...
		{
			$this->set_error('Ukuran gambar terlalu besar');
